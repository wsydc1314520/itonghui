...
import com.itonghui.tfdz.ui.fragment.GuideFragment;

import java.util.ArrayList;

public class VPGuideAdapter extends FragmentPagerAdapter {

    private ArrayList<Integer> imagelist;

    public VPGuideAdapter(FragmentManager fm, ArrayList<Integer> imagelist) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        return GuideFragment.getInstance(imagelist.get(position));
    }
