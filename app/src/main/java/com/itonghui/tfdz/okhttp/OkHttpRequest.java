...
//                            int mStatusCode = jsonObject.getInt("statusCode");
//                            if (mStatusCode == 300) {
//                                final Context contextNow = MyApplication.DHActivityManager.getManager().getTopActivity();//获取application顶部activity
//                                contextNow.startActivity(new Intent(contextNow, LoginActivity.class));
//                                ((Activity)contextNow).finish();
//                                return;
//                            }
//                        }
                        Gson mGson  = new Gson();
