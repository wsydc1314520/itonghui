...
public class ArrowRefreshHeader extends LinearLayout implements com.github.nrecyclerview.interfaces.BaseRefreshHeader{

    private static final String NR_REFRESH_KEY = "NR_REFRESH_KEY";
    private static final String NR_REFRESH_TIME_KEY = "NR_REFRESH_TIME_KEY";
    ...
    private long getLastRefreshTime(){
        SharedPreferences s =getContext().getSharedPreferences(NR_REFRESH_KEY, Context.MODE_PRIVATE);
        return s.getLong(NR_REFRESH_TIME_KEY,new Date().getTime());
    }

    private void saveLastRefreshTime(long refreshTime){
        SharedPreferences s =getContext().getSharedPreferences(NR_REFRESH_KEY, Context.MODE_PRIVATE);
        s.edit().putLong(NR_REFRESH_TIME_KEY,refreshTime).commit();
    }
